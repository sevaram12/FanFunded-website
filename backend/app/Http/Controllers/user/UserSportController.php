...
class UserSportController extends Controller
{
    public function sport_details()
    {
        try {
            ...
            $apiUrl = "https://api.the-odds-api.com/v4/sports/?apiKey=eba3924acdfde456754ad3cd5c59bd1a";
    ...
    public function american_football_odds(Request $request)
    {
        try {
            ...
            $apiKeyOdds = "eba3924acdfde456754ad3cd5c59bd1a";  // API key for odds


            // $apiKeySports = "eba3924acdfde456754ad3cd5c59bd1a";  // API key for sports
