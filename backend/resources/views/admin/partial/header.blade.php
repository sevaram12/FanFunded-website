          ...
          <div class="logo-area slide-toggle3 trader-list position-fixed top-0 d-flex align-items-center justify-content-end pt-6 pt-md-8 gap-sm-4 gap-md-5 gap-lg-7 px-4 px-lg-8">
            ...
            <div class="nav_aside px-5 p2-bg">
                ...
                <ul class="secend-actives bg1-color rounded-5 d-flex flex-column gap-5 mb-5">
                    ...
                    <li class="active">
                        <a href="{{url('user-details')}}" class="d-flex align-items-center gap-2"><i class="fa-solid fa-circle-user"></i>User Details</a>
                    </li>
                   
                    <li class="active">
                        <a href="{{url('pick-history')}}" class="d-flex align-items-center gap-2"><i class="fa-solid fa-calendar-days"></i>
                            Pick History</a>
                    </li>
                    <li class="active">
